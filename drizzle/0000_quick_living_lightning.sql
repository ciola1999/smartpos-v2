...
CREATE UNIQUE INDEX `accounts_code_branch_unique` ON `accounts` (`code`,`branch_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `addresses_owner_idx` ON `addresses` (`owner_type`,`owner_id`);--> statement-breakpoint
...
CREATE INDEX `batches_ingredient_idx` ON `batches` (`ingredient_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `categories_slug_branch_unique` ON `categories` (`slug`,`branch_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `ingredients_sku_unique` ON `ingredients` (`sku`);--> statement-breakpoint
CREATE UNIQUE INDEX `ingredients_sku_idx` ON `ingredients` (`sku`);--> statement-breakpoint
CREATE INDEX `ingredients_supplier_idx` ON `ingredients` (`supplier_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `payments_order_idx` ON `order_payments` (`order_id`);--> statement-breakpoint
CREATE TABLE `orders` (
	`id` text PRIMARY KEY NOT NULL,
	`branch_id` text NOT NULL,
	`warehouse_id` text,
...
--> statement-breakpoint
CREATE INDEX `recipe_product_idx` ON `product_recipes` (`product_id`);--> statement-breakpoint
CREATE INDEX `recipe_ingredient_idx` ON `product_recipes` (`ingredient_id`);--> statement-breakpoint
CREATE UNIQUE INDEX `recipe_unique_product_ingredient` ON `product_recipes` (`product_id`,`ingredient_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `variants_sku_product_unique` ON `product_variants` (`sku`,`product_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `products_sku_branch_unique` ON `products` (`sku`,`branch_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `poi_po_idx` ON `purchase_order_items` (`purchase_order_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `shifts_cashier_idx` ON `shifts` (`cashier_id`);--> statement-breakpoint
CREATE INDEX `shifts_branch_idx` ON `shifts` (`branch_id`);--> statement-breakpoint
...
CREATE INDEX `stock_movements_ingredient_idx` ON `stock_movements` (`ingredient_id`);--> statement-breakpoint
CREATE INDEX `stock_movements_batch_idx` ON `stock_movements` (`batch_id`);--> statement-breakpoint
CREATE INDEX `stock_movements_warehouse_idx` ON `stock_movements` (`warehouse_id`);--> statement-breakpoint
CREATE INDEX `stock_movements_reference_idx` ON `stock_movements` (`reference_id`,`reference_type`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `store_settings_branch_id_unique` ON `store_settings` (`branch_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `suppliers_code_branch_unique` ON `suppliers` (`code`,`branch_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `warehouses_branch_idx` ON `warehouses` (`branch_id`);--> statement-breakpoint
CREATE UNIQUE INDEX `warehouses_code_branch_unique` ON `warehouses` (`code`,`branch_id`);