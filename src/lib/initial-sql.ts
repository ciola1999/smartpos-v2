 ...
 *
 * Sumber: drizzle/0000_omniscient_harrier.sql (dengan IF NOT EXISTS)
 * Urutan: Tabel independen dulu, lalu tabel yang punya FOREIGN KEY.
 */
...
export const INITIAL_SQL_STATEMENTS: readonly string[] = [
  ...
  // ============================================================
  // DEPENDENT TABLES (With Foreign Keys) — Order matters!
  // ============================================================
